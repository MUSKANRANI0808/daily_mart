        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Row(
                children: [
                  Icon(Icons.filter_alt_rounded, color: Colors.black, size: 18),
                  SizedBox(width: 8),
                  Text(
                    'Select Date Filter',
                    style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.bold, color: Colors.black),
                  ),
                ],
              ),
              ...
              ListTile(
                ...
                leading: const Icon(Icons.today_rounded, color: Colors.black, size: 20),
                title: const Text('Today', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13.5, color: Colors.black)),
                trailing: _selectedDateFilter == 'Today' ? const Icon(Icons.check_circle_rounded, color: Colors.black, size: 18) : null,
                onTap: () => Navigator.pop(ctx, 'Today'),
              ),
              ListTile(
                dense: true,
                visualDensity: VisualDensity.compact,
                leading: const Icon(Icons.history_rounded, color: Colors.black, size: 20),
                title: const Text('Yesterday', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13.5, color: Colors.black)),
                trailing: _selectedDateFilter == 'Yesterday' ? const Icon(Icons.check_circle_rounded, color: Colors.black, size: 18) : null,
                onTap: () => Navigator.pop(ctx, 'Yesterday'),
              ),
              ListTile(
                dense: true,
                visualDensity: VisualDensity.compact,
                leading: const Icon(Icons.date_range_rounded, color: Colors.black, size: 20),
                title: const Text('Custom (Select From & To Date)', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13.5, color: Colors.black)),
                trailing: _selectedDateFilter == 'Custom' ? const Icon(Icons.check_circle_rounded, color: Colors.black, size: 18) : null,
                onTap: () => Navigator.pop(ctx, 'Custom'),
              ),
              ListTile(
                dense: true,
                visualDensity: VisualDensity.compact,
                leading: const Icon(Icons.restart_alt_rounded, color: Colors.black, size: 20),
                title: const Text('All Time (Clear Filter)', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13.5, color: Colors.black)),
                trailing: _selectedDateFilter == 'All Time' ? const Icon(Icons.check_circle_rounded, color: Colors.black, size: 18) : null,
